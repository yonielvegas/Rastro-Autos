...
<script>
  function openViewModal(parte) {
    ...
    document.getElementById('viewPartCode').textContent = parte.codigo || '-';
    ...
    document.getElementById('viewPartPrice').textContent = parte.precio != null ? `$${parte.precio.toFixed(2)}` : '-';
    document.getElementById('viewPartStock').textContent = parte.stock != null ? parte.stock : '-';
    document.getElementById('viewEntryDate').textContent = parte.fecha || '-';
